...
\r
const Root = () => {\r
  const [local, setLocal] = useState(Language.ZH_CN);\r
\r
  return (\r
    <>\r
      <Radio.Group\r
        ...
        options={[\r
          {\r
            label: '\u4E2D\u6587',\r
            value: Language.ZH_CN,\r
          },\r
          {\r
            label: 'English',\r
            value: Language.EN_US,\r
          },\r
        ]}\r
        onChange={(e) => {\r
